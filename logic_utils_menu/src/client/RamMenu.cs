...
namespace PixLogicUtilsMenu.Client
{
    public class RamMenu : EditComponentMenu, IAssignMyFields
    {
        ...
        {
            WS.window("PixLogicUtilsMenu - RAM")
                .configureContent(content => content
                    .vertical(20f, new RectOffset(20, 20, 20, 20), expandHorizontal: true)
                    .add(WS.inputField
                        .injectionKey(nameof(filePathInputField))
                        .fixedSize(1000, 80)
                        .setPlaceholderLocalizationKey("PixLogicUtilsMenu.FileFieldHint")
                        .disableRichText()
                    )
                    .add(WS.textLine
                        .setLocalizationKey("PixLogicUtilsMenu.FileNotFound")
                        .injectionKey(nameof(errorText))
                    )
                    .add(WS.button.setLocalizationKey("PixLogicUtilsMenu.FileLoad")
                    ...
                    .addContainer("BottomBox", bottomBox => bottomBox
                        ...
                        .addContainer("BottomInnerBox", innerBox => innerBox
                            ...
                            .addContainer("BottomBox1", container => container
                                ...
                                .add(WS.textLine.setLocalizationKey("PixLogicUtilsMenu.AddressLines"))
                                .add(WS.slider
                            ...
                            .addContainer("BottomBox2", container => container
                                ...
                                .add(WS.textLine.setLocalizationKey("PixLogicUtilsMenu.BitWidth"))
                                .add(WS.slider
        ...
        protected override void OnStartEditing()
        {
            ...
            if (FirstComponentBeingEdited.ClientCode is MultiReadRamClient)
            {
