...
namespace PixLogicUtils.Client.Menus
{
	...
	{
		protected virtual int DefaultWidth => 1000;
		protected virtual int DefaultHeight => 1500;
		...
		public override void Initialize()
		{
			...
			layoutElement.minWidth = DefaultWidth;
			layoutElement.minHeight = DefaultHeight;
		...
		private void InitializeSlider()
		{
			...
			if (MinBPP == MaxBPP)
			{
				...
				UnityHelper.ReplaceLocalizedText(displayConfigContainer, "Input count slider", "");
			}
			else
				UnityHelper.ReplaceLocalizedText(displayConfigContainer, "Input count slider", BitsPerPixelName);

		}

		private void InitializeEditConfigurationsButton()
		{
			var exactTarget = UnityHelper.FindChildByName(displayConfigContainer, "Edit Configurations Button");
			if (exactTarget != null)
			{
		...
		private int GetCurrentBitsPerPixel()
		{
		...
		private int GetCurrentConfigurationIndex()
		{
			var Data = FirstComponentBeingEdited.ClientCode.CustomDataObject
				as IDisplayConfigurationData;
