...
namespace PixLogicUtils.Client.Menus
{
	public class MultiplexerMenu : EditComponentMenu, IAssignMyFields
	{
		...
		{
			WS.window("PixLogicUtils - Multiplexer")
				.setYPosition(150)
					...
					.addContainer("BottomBox", bottomBox => bottomBox
						...
						.addContainer("BottomInnerBox", innerBox => innerBox
							...
							.addContainer("BottomBox1", container => container
								...
								.add(WS.textLine.setLocalizationKey("PixLogicUtils.MultiplexerWidth"))
								.add(WS.slider
							...
							.addContainer("BottomBox1", container => container
								.layoutGrowGapHorizontalInnerCentered()
								.add(WS.textLine.setLocalizationKey("PixLogicUtils.MultiplexerSelectorCount"))
								.add(WS.slider
